...
For a Headless Collection, open the Collections app from the Horizon. Choose a Collection and open the "Collection Settings", then navigate to the "General" tab.
