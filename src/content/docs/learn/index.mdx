...
These computers are designed for, and controlled, the enterprises that provide each app. 
...
- [What’s a personal cloud](/docs/en/learn/pc-what)
- [Why you should care](/docs/en/learn/pc-why)
