...
Unlike other cloud computers you’ve built for, Space is also a personal computer. You can build apps for yourself. You can [use](/docs/en/use) and extend [3rd party apps](/docs/en/use/space-apps/discovery) that put you in the drivers seat.  
