...
But thanks to [the personal cloud](/docs/en/learn/what-is-pc), you're also just one step away from sharing your app with the whole world. This is done via **Publishing** an app to [Deta Discovery](https://deta.space/discovery).
...
- Working with [releases](/docs/en/publish/releasing), the foundational publishing concept
