---
title: "Public Routes, Canvas Improvements and Faster Releases"
date: "14 Oct 2022"
layout: "@changelogs"
description: "Public routes are now available in Space Alpha in addition to improvements to the Canvas, faster releases and various bug fixes and under the hood stability improvements."
---
...
- Include app installations on the Canvas
- Improve design of Canvas items to make it easier to distinguish Builder instances and projects from normal apps
- Sync Canvas state across devices
- Add Docs app
...
We are working hard on new features and you can expect big changes coming very soon! Thanks for being a crucial part in the early stages of Space and for all the great feedback we have received <DetaHeart />
