...
Since the introduction of Deta Space, developers have been asking for a better experience when building locally for Space. Whether it is managing keys or coordinating between two separate [Micros](/docs/en/build/fundamentals/the-space-runtime/micros#whats-a-micro), local development requires unnecessary work.
...
If your Spacefile contains a [Scheduled Action](/docs/en/build/fundamentals/the-space-runtime/micros#scheduled-actions), you can also now trigger it locally for testing.
