...
To get started with scheduled actions, update the [Space CLI](/docs/en/reference/cli) to the latest version (`space version upgrade`) and checkout the scheduled actions [Developer Basics](/docs/en/basics/micros#scheduled-actions) and [User Manual](/manual/apps#schedules).
...
We hope you like these changes and as always thank you for all the great feedback we have received! <DetaHeart />
