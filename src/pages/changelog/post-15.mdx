...
Core to the idea of a personal cloud computer is the ability control your own data. This includes being able to take your data with you outside of Space, to use for whatever you want.
...
Want to start fresh? You can now wipe all the data in your app instance from the "Data" view of your app instance. This will delete all the Bases and Drives that your app uses. 
