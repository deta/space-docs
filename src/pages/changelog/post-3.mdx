...
<Image src="/changelog_assets/base-ui.png" alt="Base UI Screenshot" subtext="New Base UI editing mode" width="90%" />
...
<Image src="/changelog_assets/release-card.png" alt="Release Card Screenshot" subtext="Bigger release card" width="90%" />
