...
Learn more about the `.spaceignore` file and the default ignore list in the [docs](https://deta.space/docs/en/basics/revisions#ignoring-files-and-directories).
