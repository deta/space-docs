---
title: "Rust Enters Alpha, Bug Fixes and Quality of Life Improvements"
date: "30 Mar 2023"
layout: "@changelogs"
...
## Rust enters alpha with Cargo support

You can now use Cargo and deploy your Rust apps to Space! Rust support is still in alpha.
...
```json
{
  ...
  "yaml.schemas": {
      "https://raw.githubusercontent.com/deta/space-cli/main/internal/spacefile/schemas/spacefile.v0.schema.json": ["Spacefile"]
  }
}
```
