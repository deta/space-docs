...
If you haven't installed the CLI yet, you can do so by following [the instructions in our docs](/docs/en/build/basics/space-cli#installation).
...
/docs/en/build/fundamentals/development/builder/xyz?event=goshawk-scgd
```
