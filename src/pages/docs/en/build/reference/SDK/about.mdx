...
To start working with the SDK, you need to either use the `space dev` command or provide a [Data Key](/docs/en/build/fundamentals/data-storage#data-keys) in an environment variable called `DETA_PROJECT_KEY`.
