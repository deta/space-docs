...
You can use the [Base SDK](./sdk/base) to [`put`](./sdk/bas#put), [`put_many`](./sdk/base#put_many) or [`insert`](./sdk/base#insert) items with an expiration timestamp (or the [HTTP API](./http-api/base) directly).
