...
The CLI will ask you to name your project, we will call ours "awesome-app". Then it will try to detect which framework or language you are using and show you what's found. In our case it should correctly indentify our Svelte app with the following message, prompting you to confirm:
