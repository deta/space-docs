...
<Image src="/blog_assets/discovery.png" alt="Discovery App Page Screenshot" subtext="Discovery App Page" width="90%" />

Additionally you can now choose to list your app publicly on Discovery for others to discover and install:

<Image src="/blog_assets/discovery-list.png" alt="Discovery App List Screenshot" subtext="Discovery App List" width="90%" />
...
<Image src="/blog_assets/listing-builds.png" alt="Listing Builds Screenshot" subtext="Build Status in the 'Develop' tab" width="90%" />
