...
<Image src="/docs_assets/archive/collections/empty-collection.png" alt="Empty Collection" width="90%" background />
...
<Image src="/docs_assets/archive/collections/nothing-open.png" alt="Nothing Open" width="90%" background />
...
<Image src="/docs_assets/archive/collections/select-resource.png" alt="Select Resource" width="90%" background />

Tabs are part of the Collections UI and allow you to quickly jump between resources:

<Image src="/docs_assets/archive/collections/tabs.png" alt="Tabs" width="90%" background />
...
<Image src="/docs_assets/archive/collections/empty-base.png" alt="Empty Base" width="90%" background />
...
<Image src="/docs_assets/archive/collections/base-item-unsaved.png" alt="Unsaved Base Item" width="90%" background />

### Viewing a Drive

When you open a Drive you’ll see the Drive UI which you can use to upload and manage files:

<Image src="/docs_assets/archive/collections/empty-drive.png" alt="Empty Drive" width="90%" background />

Just drag a file onto the grey box and it will be uploaded to your Drive.

<Image src="/docs_assets/archive/collections/uploaded-file.png" alt="Uploaded File" width="90%" background />
...
<Image src="/docs_assets/archive/collections/data-keys.png" alt="Data Keys" width="90%" background />
