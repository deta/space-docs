...
If you aren't afraid of downtime, remove your custom domain in the Deta Cloud Legacy app and then [add a custom domain to your Space app](https://deta.space/manual/features/custom-domains).
